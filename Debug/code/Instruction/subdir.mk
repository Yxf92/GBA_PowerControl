...
C_SRCS += \
../code/Instruction/PCDataConvert.c 

OBJS += \
./code/Instruction/PCDataConvert.o 

C_DEPS += \
./code/Instruction/PCDataConvert.d 


# Each subdirectory must supply rules for building sources it contributes
code/Instruction/%.o: ../code/Instruction/%.c code/Instruction/subdir.mk
	@echo 'Building file: $<'
