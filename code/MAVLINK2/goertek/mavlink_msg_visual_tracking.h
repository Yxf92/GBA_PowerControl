...
#define MAVLINK_MSG_ID_VISUAL_TRACKING_MIN_LEN 33
#define MAVLINK_MSG_ID_4000_LEN 33
#define MAVLINK_MSG_ID_4000_MIN_LEN 33

#define MAVLINK_MSG_ID_VISUAL_TRACKING_CRC 99
#define MAVLINK_MSG_ID_4000_CRC 99
...
#define MAVLINK_MESSAGE_INFO_VISUAL_TRACKING { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_visual_tracking_t, time_usec) }, \
         { "track_quality", NULL, MAVLINK_TYPE_UINT8_T, 0, 32, offsetof(mavlink_visual_tracking_t, track_quality) }, \
         { "width", NULL, MAVLINK_TYPE_FLOAT, 0, 8, offsetof(mavlink_visual_tracking_t, width) }, \
         { "height", NULL, MAVLINK_TYPE_FLOAT, 0, 12, offsetof(mavlink_visual_tracking_t, height) }, \
         { "x", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_visual_tracking_t, x) }, \
         { "y", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_visual_tracking_t, y) }, \
         { "center_x", NULL, MAVLINK_TYPE_FLOAT, 0, 24, offsetof(mavlink_visual_tracking_t, center_x) }, \
         { "center_y", NULL, MAVLINK_TYPE_FLOAT, 0, 28, offsetof(mavlink_visual_tracking_t, center_y) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_VISUAL_TRACKING { \
...
static inline uint16_t mavlink_msg_visual_tracking_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, uint8_t track_quality, float width, float height, float x, float y, float center_x, float center_y)
{
    ...
    _mav_put_float(buf, 24, center_x);
    _mav_put_float(buf, 28, center_y);
    _mav_put_uint8_t(buf, 32, track_quality);
...
{
    return mavlink_msg_visual_tracking_pack(system_id, component_id, msg, visual_tracking->time_usec, visual_tracking->track_quality, visual_tracking->width, visual_tracking->height, visual_tracking->x, visual_tracking->y, visual_tracking->center_x, visual_tracking->center_y);
}
...
{
    return mavlink_msg_visual_tracking_pack_chan(system_id, component_id, chan, msg, visual_tracking->time_usec, visual_tracking->track_quality, visual_tracking->width, visual_tracking->height, visual_tracking->x, visual_tracking->y, visual_tracking->center_x, visual_tracking->center_y);
}
...
static inline void mavlink_msg_visual_tracking_send(mavlink_channel_t chan, uint64_t time_usec, uint8_t track_quality, float width, float height, float x, float y, float center_x, float center_y)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_VISUAL_TRACKING_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_visual_tracking_send(chan, visual_tracking->time_usec, visual_tracking->track_quality, visual_tracking->width, visual_tracking->height, visual_tracking->x, visual_tracking->y, visual_tracking->center_x, visual_tracking->center_y);
#else
 ...
 */
static inline void mavlink_msg_visual_tracking_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, uint8_t track_quality, float width, float height, float x, float y, float center_x, float center_y)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
